# Script for deploying EBMS Release 4.4.1.5 ("Klamath") to a CBIIT tier.
...
export REPO_URL=$NCIOCPL/ebms/tarball/Klamath
export WORKDIR=/tmp/ebms-4.4.1.5
...
if [ -d $WORKDIR ]; then
    TIMESTAMPED=`/bin/date +"/tmp/ebms-4.4.1.5-%Y%m%d%H%M%S"`
