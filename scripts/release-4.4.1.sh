# Script for deploying EBMS Release 4.4.1 ("Monongahela") to a CBIIT tier.
...
export REPO_URL=$NCIOCPL/ebms/tarball/Monongahela
export WORKDIR=/tmp/ebms-4.4.1
...
if [ -d $WORKDIR ]; then
    TIMESTAMPED=`/bin/date +"/tmp/ebms-4.4.1-%Y%m%d%H%M%S"`
