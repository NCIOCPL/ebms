# Script for deploying EBMS Release 4.4.3 ("Badlands") to a CBIIT tier.
...
export REPO_URL=$NCIOCPL/ebms/tarball/Badlands
export WORKDIR=/tmp/ebms-4.4.3
...
if [ -d $WORKDIR ]; then
    TIMESTAMPED=`/bin/date +"/tmp/ebms-4.4.3-%Y%m%d%H%M%S"`
